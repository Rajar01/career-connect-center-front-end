  ...
  return (
    <main className="h-screen flex flex-row items-center justify-between gap-x-[130px] pl-[130px] bg-white">
      <div className="basis-4/12 flex flex-col items-center justify-center text-darkAccent">
        ...
        <h2 className="text-[19px] mb-4">Connect with talent and opportunities</h2>
        <Tabs
          className="mb-6"
          color="primary"
          classNames={{
        ...
        <Input
          ...
          type={isVisible ? 'text' : 'password'}
        />
        <Button className="h-[52px] mb-2 rounded-lg text-base" fullWidth color="primary">Register</Button>
