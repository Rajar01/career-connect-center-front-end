    ...
    <>
      ...
      <main className="px-[130px] pt-16 mb-20 bg-white">
        <section className="mb-8">
          <h1 className="text-darkAccent text-[40px] font-bold mb-1">Your Saved Jobs</h1>
          <h2 className="text-darkAccent text-base mb-4">Review and manage the jobs you’ve saved. Apply when you're ready to take the next step in your career.</h2>
        ...
        <section className="flex flex-row gap-x-8 items-start w-full">
          ...
          <div className="basis-9/12 flex flex-col items-center justify-center">
            <div className="flex flex-row items-center justify-end w-full h-12  mb-6">
              <span className="text-darkAccent text-[19px] font-bold">All Saved Job (10)</span>
            </div>
